...
import { handleCreateContract,  handleDeleteContract,  handleGetCarListForContract,  handleUpdateContract, handleGetContracts,  handleGetCustomerListForContract, handleGetusersListForContract, } from '../controllers/contracts.controller';
...
//TODO: 계약용 유저 목록 조회
contracts.get('/users', allow([USER_ROLE.USER]), handleGetusersListForContract);
